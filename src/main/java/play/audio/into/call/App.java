...
public class App {
  public static void main(String[] args) throws Exception {
    ...
    NexmoClient client = NexmoClient.builder().applicationId(dotenv.get("NEXMO_APPLICATION_ID"))
        .privateKeyPath(privateKeyPath).build();
    ...
    get("/webhooks/answer", (req, res) -> {
      ...
      TalkAction intro = TalkAction.builder("Please wait while we connect you to the conference.")
          .voiceName(VoiceName.RUSSELL).build();

      ConversationAction conversation = ConversationAction.builder("Test conference").build();
